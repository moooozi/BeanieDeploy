...
class PartitionUuid(ABC):
    """
    Abstract utility class for normalizing partition UUID/GUID formats.
    
    Provides methods to convert UUIDs between different representations.
    """
