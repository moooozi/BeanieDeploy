...
from tkinter_templates import FONTS_small, TextLabel
...
class PageInstallFailed(Page):
    ...
    def init_page(self):
        ...
        help_label = TextLabel(
            self.page_frame, text=_("install.failed.help"), font=FONTS_small
        )
    ...
    def _retry_installation(self):
        ...
        logging.info("User chose to retry installation")
    ...
    def _quit_application(self):
        ...
        logging.info("User chose to quit from installation failed page")
        import sys
