...
desktop_hints = {
    "KDE Plasma": "KDE غني بالميزات، قابل للتخصيص بشكل كبير، ويحتوي على تخطيط مشابه لـ Windows بشكل افتراضي",
...
total_download = "إجمالي التنزيل: %s"
init_download = "التنزيل الأولي: %s"
...
additional_setup_now = (
    "قم بإعداد الإعدادات المحلية والمنطقة الزمنية وتخطيط لوحة المفاتيح الآن"
)
...
password_reminder_txt = (
    "سيكون بإمكانك تعيين كلمة مرور لحساب المستخدم الخاص بك بعد التثبيت"
)
...
enable_rpm_fusion = (
    "تمكين المستودعات الإضافية لدعم البرامج الموسعة وترميز الوسائط المتعددة"
)
...
distro_hint = {
    "Fedora Workstation": "الإصدار الرئيسي من Fedora مع بيئة سطح المكتب GNOME",
...
job_checksum_failed_txt = (
    "فشل في التحقق من سلامة الملف المُنزّل، هل تريد المتابعة على أي حال؟"
)
job_checksum_mismatch = "عدم تطابق الخواص"
job_checksum_mismatch_txt = (
    "الملف المُنزّل لديه خاصية SHA256 غير متوقعة ولا يمكن الوثوق به.\n"
    "\nخاصية الملف:\n%s"
    "\nالخاصية المتوقعة:\n%s\n"
...
job_copying_to_tmp_part = (
    "نسخ الملفات المطلوبة لوسائط التثبيت إلى القسم التمهيدي المؤقت..."
)
...
finished_text = (
    "مطلوب إعادة تشغيل لمتابعة التثبيت، "
    "انقر على '%s' لإعادة التشغيل الآن أو على '%s' لإعادة التشغيل يدويًا في وقت لاحق"
