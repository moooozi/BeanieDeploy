...
check_existing_download_files = "Prüfen auf vorhandene Dateien aus früheren Installationen"
...
additional_setup_now = "Richten Sie jetzt Ihr Gebietsschema, Ihre Zeitzone und Ihre Tastaturbelegung ein"
...
encrypt_reminder_txt = "Sie werden später aufgefordert, das Verschlüsselungspasswort einzugeben"
...
password_reminder_txt = "Sie können das Passwort für Ihr Benutzerkonto nach der Installation festlegen"
...
windows_options = {'dualboot': 'Neben Windows installieren',
...
verify_question = "Das wird passieren. Klicken Sie auf %s, um die Installation zu starten" % btn_install
verify_text = {
...
distro_hint = {'Fedora Workstation': 'Die Hauptausgabe von Fedora mit der GNOME-Desktop-Umgebung'}
...
job_checksum_mismatch_txt = "Die heruntergeladene Datei hat einen unerwarteten SHA256-Hash und kann nicht vertraut werden.\n" \
                            "\nDatei-Hash:\n%s" \
                            "\nErwarteter Hash:\n%s\n" \
                            "\nDies bedeutet in der Regel, dass die Datei nicht ordnungsgemäß heruntergeladen wurde." \
                            "\nVersuchen Sie, erneut herunterzuladen?"

job_creating_tmp_part = "Erstellen einer temporären Bootpartition für Installationsmedien..."
