...
def run():
    ...
    # *************************************************************************************************************
    tkt.generic_page_layout(parent, LN.desktop_question, LN.btn_next, lambda: next_btn_action())
    ...
    frame_desktop = ttk.Frame(parent)
    ...
    combo_list_spin = ttk.Combobox(parent, values=dict_spins_with_fullname_keys, state='readonly')
    ...
    frame_spin_info = tk.Frame(parent)
    ...
    def validate_input(*args):
        ...
        if spin_index is not None:
            ...
            if GV.SELECTED_SPIN.is_live_img:
                GV.INSTALL_OPTIONS.live_img_url = GV.APP.live_img_url
