...
"%WINRAREXE%" a -sfx -s -md32m -m3 -iicon"%PROJECTDIR%\src\resources\style\app-icon.ico" -k -z"winrar_sfx_options.txt" "%OUTPUTDIR%\%SFXName%" "%PROJECTDIR%\interpreter" "%PROJECTDIR%\src" "%PROJECTDIR%\ReleaseInfo.txt"
