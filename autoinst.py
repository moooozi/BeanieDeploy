...
def func4(territory=None, other_langs=None):
    ...
    for i in range(len(langs_locales_sorted)):
        ...
        langs_locales_sorted[i][0] = (lang_english_name, lang_native_name, langs_locales_sorted[i][0])
        for j in range(len(langs_locales_sorted[i][1])):
            ...
            locale_data = (locale_name_english, locale_name_native, langs_locales_sorted[i][1][j])
